...
unsigned long long regs[8 + 8 + 1 + 4 + 16];
...
int show(unsigned long long *regs)
{
    ...
    for (int i = 0; i < 4; i++) {
        ...
        my_puts(s);
        my_puts(":\t");
        my_itoa(t3, regs[4 * i + 3 + 21], 16);
        my_itoa(t2, regs[4 * i + 2 + 21], 16);
        my_itoa(t1, regs[4 * i + 1 + 21], 16);
        my_itoa(t, regs[4 * i + 21], 16);
        //my_itoa(s, regs[77], 16);
        //widen(t, s, 32);
        widen(v3, t3, 16);
        my_puts(v3);
